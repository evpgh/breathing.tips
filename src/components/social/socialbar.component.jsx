...
export const Socialbar = () => {
    return (
        <div className="section light-bg" id="social">
            <div className="container text-center">
                <h3> share with people you love </h3>
                <a className="resp-sharing-button__link" href="https://twitter.com/intent/tweet/?text=%22The%20missing%20pillar%20in%20health%20is%20breath%22%0A%40MrJamesNestor%0A---%0A%F0%9F%98%A4%F0%9F%A7%98%20&amp;url=https%3A%2F%2Fbreathing.tips&amp;via=breathingtips&amp;hashtags=breathing,meditation" rel="noopener" aria-label="Twitter">
                ...
                <a className="resp-sharing-button__link" href="https://facebook.com/sharer/sharer.php?u=https%3A%2F%2Fbreathing.tips" rel="noopener" aria-label="Share on Facebook">
                ...
                <a className="resp-sharing-button__link" href="mailto:?subject=The%20missing%20pillar%20to%20health%20is%20breath&amp;body=https%3A%2F%2Fbreathing.tips" target="_self" rel="noopener" aria-label="Share by E-Mail">
